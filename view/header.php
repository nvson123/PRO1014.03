                ...
                <div class="header-info-items">
                  <div class="info-items">
                    <ul>
                      ...
                      <li class="account"><i class="fa fa-user"></i><a href="index.php?act=login">Account</a></li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div class="header-middle-align-center">
                <div class="header-search-area">
                  <form class="header-searchbox">
                    ...
                    <button class="btn-submit" name="timkiem" type="submit"><i class="pe-7s-search"></i></button>
                  </form>
                </div>
              </div>
