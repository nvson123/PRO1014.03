        ...
        <div class="app-main">
            <nav class="sidebar bg-primary">
                <ul>
                    ...
                    <li>
                        <a href="index.php?url=list-category"><i class="fa-solid fa-folder-open ico-side"></i>Quản lí danh muc</a>
                    </li>
                    <li>
                        <a href="index.php?url=list-product"><i class="fa-solid fa-mug-hot ico-side"></i>Quản lí sản phẩm</a>
                    </li>
                    <li>
